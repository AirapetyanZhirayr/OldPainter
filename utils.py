...
# from KUKAPI.utils.camera import PixelinkCam
...
def img2patches(img, m_grid, s, adder, to_tensor=True):
    # input img: h, w, сдвиг, 3 (np.float32)
...
def patches2img(img_batch, m_grid, adder, to_numpy=True):
